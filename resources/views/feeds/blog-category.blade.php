{!! '<'.'?'.'xml version="1.0" encoding="UTF-8" ?>' !!}
    <rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/"
        ...
        <channel>
            <title>
                <![CDATA[{{ str_replace('{category}', $items->first()?->category->name ?? 'Category', $meta['title']) }}]]>
            </title>
            <link>
            <![CDATA[{{ url('/') }}]]>
            </link>
            <description>
                <![CDATA[{{ str_replace('{category}', $items->first()?->category->name ?? 'Category', $meta['description']) }}]]>
            </description>
