            ...
            <div class="admin-card p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="url" id="client_website" name="client_website"
                            value="{{ old('client_website', $testimonial->client_website) }}"
                    ...
                    <div>
                        ...
                        <input type="url" id="client_linkedin" name="client_linkedin"
                            value="{{ old('client_linkedin', $testimonial->client_linkedin) }}"
                ...
                <div class="mt-4">
                    ...
                    <textarea id="testimonial" name="testimonial" rows="4" required
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white @error('testimonial') border-red-500 @enderror">{{ old('testimonial', $testimonial->testimonial) }}</textarea>
                    @error('testimonial')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="admin-card p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="client_role" name="client_role"
                    ...
                    <div>
                        ...
                        <textarea id="role_description" name="role_description" rows="2"
                            ...
                            class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">{{ old('role_description', $testimonial->role_description) }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="country_code" name="country_code"
                            value="{{ old('country_code', $testimonial->country_code) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="country_name" name="country_name"
                            value="{{ old('country_name', $testimonial->country_name) }}"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="latitude" name="latitude"
                                    value="{{ old('latitude', $testimonial->latitude) }}"
                            ...
                            <div>
                                ...
                                <input type="number" id="longitude" name="longitude"
                                    value="{{ old('longitude', $testimonial->longitude) }}"
            ...
            <div class="admin-card p-6">
                ...
                <div>
                    <label for="client_image" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        {{ $testimonial->client_image ? 'Replace Image' : 'Profile Image' }} (Optional)
                    </label>
