...
@section('title', 'Create Match - Admin Panel')
...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create New Match</h1>
</div>

<form action="{{ route('admin.sports.matches.store') }}" method="POST">
    @csrf
            ...
            <div class="admin-card p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="match_type" name="match_type" value="{{ old('match_type') }}"
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" name="meta_description" rows="3"
                            ...
                            placeholder="Brief description for SEO purposes...">{{ old('meta_description') }}</textarea>
