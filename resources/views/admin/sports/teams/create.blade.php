...
@section('title', 'Create Team - Admin Panel')
...
<form action="{{ route('admin.sports.teams.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="admin-card p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="abbreviation" name="abbreviation" required maxlength="5" value="{{ old('abbreviation') }}"
            ...
            <div class="admin-card p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="country_code" name="country_code" maxlength="2" value="{{ old('country_code') }}"
        ...
        <div class="space-y-6">
            ...
            <div class="admin-card p-6">
                ...
                <div>
                    ...
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Recommended: Square image, max 2MB</p>
                </div>
            </div>
