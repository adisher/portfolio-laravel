    ...
    public function run(): void
    {
        $categories = [
            [
                ...
                'meta_title' => 'AI & Machine Learning Articles | LLMs, Tools & Trends',
                'meta_description' => 'In-depth articles on AI and machine learning: LLMs, GPT and Claude, neural networks, agents, and the tools reshaping how software gets built.',
                'color' => '#8B5CF6', // Purple
                'is_active' => true,
            ...
            [
                ...
                'meta_title' => 'Web Development Articles | Frontend & Backend Tutorials',
                'meta_description' => 'Practical web development tutorials covering frontend frameworks, backend architecture, JavaScript, PHP/Laravel, and modern build tooling.',
                'color' => '#3B82F6', // Blue
                'is_active' => true,
            ...
            [
                ...
                'meta_title' => 'Tech News & Industry Updates | Product Launches, Funding, M&A',
                'meta_description' => 'Timely commentary on tech news: product launches, funding rounds, acquisitions, and the moves shaping the industry.',
                'color' => '#EF4444', // Red
                'is_active' => true,
            ...
            [
                ...
                'meta_title' => 'Programming Articles | Languages, Algorithms & Best Practices',
                'meta_description' => 'Programming tutorials and deep dives: languages, algorithms, data structures, design patterns, and clean-code practices.',
                'color' => '#10B981', // Green
                'is_active' => true,
            ...
            [
                ...
                'meta_title' => 'Design & UX Articles | UI Principles, Systems & Accessibility',
                'meta_description' => 'Articles on UI/UX design: design systems, accessibility, prototyping, typography, and interaction patterns that hold up in production.',
                'color' => '#F59E0B', // Amber
                'is_active' => true,
            ...
            [
                ...
                'meta_title' => 'DevOps & Cloud Articles | CI/CD, Kubernetes & Infrastructure',
                'meta_description' => 'DevOps and cloud engineering articles: CI/CD pipelines, Kubernetes, containerization, infrastructure as code, and observability.',
                'color' => '#06B6D4', // Cyan
                'is_active' => true,
            ...
            [
                ...
                'meta_title' => 'Career & Growth Articles | Advice for Tech Professionals',
                'meta_description' => 'Career advice for tech professionals: job search, productivity, leadership, and professional growth.',
                'color' => '#EC4899', // Pink
                'is_active' => true,
